...
Questions increase in difficulty as the game progresses

✅ Toast Messages

Displays a toast notification for correct answers

Built using a custom SwiftUI toast component

❌ Game Over Screen

Shown when the player selects a wrong answer

Displays loss information clearly

🏆 Winning Screen

Celebrates the player for successfully completing the game

🎨 Custom Styling

Unique UI design (not a copy of the TV show)

Clean layouts, readable typography, and engaging visuals
